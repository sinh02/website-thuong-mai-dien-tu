  ...
  <div class="row">
    ...
    <div id="content" class="col-sm-9">
      ...
      <div class="row">
        ...
        <div class="col-sm-3" ><img style="padding: 0px; width: 50vw;" src="<?php echo $category_thumb; ?>" alt="<?php echo $category_name; ?>" title="<?php echo $category_name; ?>" class="img-thumbnail" /></div>
        <?php } ?>
        <?php if ($category_description) { ?>
        <div class="col-sm-9  "><?php echo $category_description; ?></div>
        <?php } ?>
      </div>
      <hr>
      <?php } ?>
      ...
      <div class="row">
        ...
        <div class="product-layout product-list col-xs-12" >
          <div class="product-thumb" style="border-radius: 7px;">
            <div class="image"><a href="<?php echo $product['href']; ?>"><img style="width: 100%; border-top-left-radius: 7px; border-top-right-radius: 7px;" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a></div>
            <div>
              <div class="caption">
