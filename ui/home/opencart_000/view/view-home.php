        ...
        <div id="content" >
                ...
                <?php foreach (banner_imageActives() as $banner) { ?>
					<li style="width: 1132px; float: left; display: block;">
						...
						<a href="<?php echo $banner['link']; ?>">
							<img style="width: 100%;" src="<?php echo $banner['url_image_resized']; ?>" alt="<?php echo $banner['title']; ?>" class="img-fluid " />
						</a>
						<?php } else { ?>
						<img src="<?php echo $banner['url_image_resized']; ?>" alt="<?php echo $banner['title']; ?>" class="img-fluid" />
						<?php } ?>
		    ...
		    <div class="row"  style="border-bottom: #ddd solid 1px;">
				...
				<div class="col-sm-4">
					...
					<img style="width: 100%; border-radius: 7px;" src="<?php echo $category['url_image_resized']; ?>" alt="banner-3" title="banner-3" width="<?php echo $category['width']?>" height="<?php echo $category['height']?>" style="transition: all 0.5s ease;z-index: -100">
					<div class="s-desc">
            ...
            <div class="row product-layout">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="product-thumb transition" style="border-radius: 7px;">
                        <div class="image">
                            <a href="<?php echo $product['href']; ?>">
                            	<img style="width: 100%; border-radius: 7px;" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive">
                            </a>
                        </div>
                        <div class="caption">
